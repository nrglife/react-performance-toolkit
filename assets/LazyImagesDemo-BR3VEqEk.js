import{g as S,e as k,r as c,u as R,j as e,s as z,f as O,h as W,n as F,z as C,A as L,B as m,C as A,T as s,b as $,d as T,a as U,G as w}from"./index-DKjnRRjj.js";import{D as M,A as y,a as I,C as f}from"./CodeBlock-twlZ-06y.js";import{F as B,S as E}from"./Switch-D8XY5-Yt.js";import"./useFormControl-ChbfG2tX.js";function D(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function P(t){return parseFloat(t)}function H(t){return S("MuiSkeleton",t)}k("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const N=t=>{const{classes:a,variant:n,animation:o,hasChildren:l,width:d,height:i}=t;return W({root:["root",n,o,l&&"withChildren",l&&!d&&"fitContent",l&&!i&&"heightAuto"]},H,a)},v=L`
  0% {
    opacity: 1;
  }
