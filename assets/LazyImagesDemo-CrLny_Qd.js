import{j as e,h as r,M as I,t as w,l as y,g as s,p as L,r as C,F as S,u as z,s as O,o as v,D as f}from"./mui-vendor-BcogAy2T.js";import{r as a}from"./react-vendor-bYt7__KG.js";import{D as R,C as u}from"./CodeBlock-DwP4a17t.js";import"./index-C8ZS78_l.js";import"./tanstack-query-qmwwa--H.js";function W(n={}){const{threshold:i=0,root:o=null,rootMargin:d="0px"}=n,[g,l]=a.useState(!1),[c,x]=a.useState(!1),h=a.useRef(null);return a.useEffect(()=>{const t=h.current;if(!t)return;const b=new IntersectionObserver(([m])=>{l(m.isIntersecting),m.isIntersecting&&!c&&x(!0)},{threshold:i,root:o,rootMargin:d});return b.observe(t),()=>{b.disconnect()}},[i,o,d,c]),{targetRef:h,isIntersecting:g,hasIntersected:c}}function F({src:n,alt:i,width:o="100%",height:d=200,threshold:g=.1,onLoad:l}){const[c,x]=a.useState(!1),[h,t]=a.useState(!1),{targetRef:b,hasIntersected:m}=W({threshold:g});a.useEffect(()=>{m&&!h&&t(!0)},[m,h]);const j=()=>{x(!0),l&&l()},p=()=>{console.error(`Failed to load image: ${n}`)};return e.jsxs(r,{ref:b,sx:{width:o,height:d,position:"relative",overflow:"hidden",borderRadius:1,bgcolor:"action.hover"},children:[!m&&e.jsx(I,{variant:"rectangular",width:"100%",height:"100%",animation:!1}),m&&!c&&e.jsx(r,{sx:{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",height:"100%",position:"absolute",top:0,left:0},children:e.jsx(w,{size:40})}),h&&e.jsx(r,{component:"img",src:n,alt:i,onLoad:j,onError:p,sx:{width:"100%",height:"100%",objectFit:"cover",opacity:c?1:0,transition:"opacity 0.3s ease-in-out"}})]})}const k=n=>Array.from({length:n},(i,o)=>({id:o+1,src:`https://picsum.photos/400/300?random=${o+1}`,alt:`Demo image ${o+1}`}));function P(){const[n,i]=a.useState(!0),[o,d]=a.useState(0),g=a.useMemo(()=>k(50),[]),l=()=>{d(t=>t+1)};return e.jsxs(R,{title:"Lazy Loading Images Demo",description:"See how IntersectionObserver enables efficient image loading by only loading images when they enter the viewport",children:[e.jsxs(y,{severity:"info",sx:{mb:3},children:[e.jsx(s,{variant:"body2",sx:{fontWeight:"bold",mb:1},children:"🎯 Try This: Scroll down slowly"}),e.jsx(s,{variant:"body2",sx:{mb:1},children:"Watch images load only as they come into view. With lazy loading ON, images load on-demand. With it OFF, all 50 images load immediately."}),e.jsx(s,{variant:"body2",sx:{fontStyle:"italic",fontSize:"0.875rem"},children:"💡 Notice: The loaded count increases as you scroll, not all at once!"})]}),e.jsx(L,{sx:{mb:3},children:e.jsx(C,{children:e.jsxs(r,{sx:{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:2},children:[e.jsx(S,{control:e.jsx(z,{checked:n,onChange:t=>{i(t.target.checked),d(0)}}),label:e.jsx(r,{sx:{display:"flex",alignItems:"center",gap:1},children:e.jsx(s,{variant:"body2",children:n?"✅ Lazy Loading ON":"❌ Lazy Loading OFF"})})}),e.jsxs(r,{sx:{display:"flex",alignItems:"center",gap:2},children:[e.jsxs(s,{variant:"body2",color:"text.secondary",children:["Total images: ",e.jsx("strong",{children:"50"})]}),e.jsx(O,{label:`${o} loaded`,size:"small",color:o===50?"success":"primary",sx:{fontFamily:"monospace"}})]})]})})}),e.jsxs(y,{severity:n?"success":"warning",sx:{mb:3},children:[e.jsx(s,{variant:"body2",sx:{fontWeight:"bold",mb:1},children:n?"✅ With Lazy Loading:":"❌ Without Lazy Loading:"}),n?e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"body2",sx:{mb:1},children:"• Images load only when they enter the viewport"}),e.jsx(s,{variant:"body2",sx:{mb:1},children:"• Faster initial page load (only loads visible images)"}),e.jsx(s,{variant:"body2",sx:{mb:1},children:"• Saves bandwidth (doesn't load images user never sees)"}),e.jsx(s,{variant:"body2",children:"• Better performance on slow connections"})]}):e.jsxs(e.Fragment,{children:[e.jsx(s,{variant:"body2",sx:{mb:1},children:"• All 50 images load immediately on page load"}),e.jsx(s,{variant:"body2",sx:{mb:1},children:"• Slow initial page load (downloads all images at once)"}),e.jsx(s,{variant:"body2",sx:{mb:1},children:"• Wastes bandwidth loading images user may never see"}),e.jsx(s,{variant:"body2",children:"• Poor experience on slow connections"})]})]}),e.jsx(r,{sx:{mb:3},children:e.jsx(v,{container:!0,spacing:2,children:g.map(t=>e.jsxs(v,{size:{xs:12,sm:6,md:4,lg:3},children:[n?e.jsx(F,{src:t.src,alt:t.alt,height:200,onLoad:l}):e.jsx(r,{component:"img",src:t.src,alt:t.alt,onLoad:l,sx:{width:"100%",height:200,objectFit:"cover",borderRadius:1}}),e.jsxs(s,{variant:"caption",color:"text.secondary",sx:{mt:.5,display:"block"},children:["Image ",t.id]})]},t.id))})}),e.jsx(f,{sx:{my:4}}),e.jsxs(r,{children:[e.jsx(s,{variant:"h6",gutterBottom:!0,children:"Implementation"}),e.jsx(u,{title:"✅ Lazy Image Component",code:`import { useIntersectionObserver } from './hooks/useIntersectionObserver';
